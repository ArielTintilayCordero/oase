...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="">
                <a href="{{ route('admin.operators.create') }}" class="btn btn-outline-info mb-4">
                    <i class="bi bi-plus-square"></i>Adicionar Operador</a>
            </div>
                ...
                <tbody>
                    @foreach ($operators as $item)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('admin.operators.edit', $item) }}">
                                    <i class="iconoir-edit-pencil"></i>
                                </a>
                                <form action="{{ route('admin.operators.destroy', $item) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
