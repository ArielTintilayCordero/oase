...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="">
                <a href="{{ route('admin.services.create') }}" class="btn btn-outline-info mb-4">
                ...
                <tbody>
                    @foreach ($services as $item)
                        <tr>
                            ...
                            <td>
                                {{-- @foreach ($item->subservices as $subservice)
                                    {{ $subservice->nombre }}
                                    <hr>
                                @endforeach --}}
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('admin.services.edit', $item->id) }}">
