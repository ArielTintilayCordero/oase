...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="">
                <a href="{{ route('admin.clients.create') }}" class="btn btn-outline-info mb-4">
                    <i class="bi bi-plus-square"></i>Adicionar Cliente</a>
            </div>
                ...
                <tbody>
                    @foreach ($clients as $item)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('admin.clients.edit', $item) }}" >
